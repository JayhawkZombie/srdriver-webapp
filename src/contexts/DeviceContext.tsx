...
export const DeviceProvider: React.FC<DeviceProviderProps> = ({ children }) => {
	...
	const connectDeviceBLE = useCallback(
		async (callback: ConnectionCallback) => {
			try {
	...
	const connectDeviceWebSocket = useCallback(
		async (ip: string, callback: ConnectionCallback) => {
			try {
				setIsConnecting(true);
				setError(null);
