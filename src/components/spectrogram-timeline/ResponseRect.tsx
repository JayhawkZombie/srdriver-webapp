 ...
 const ResponseRect: React.FC<ResponseRectProps> = React.memo(
     ({
         ...
         const mainX = dragMain
             ? dragMain.x
             : dragLeftX !== null
             ? dragLeftX + HANDLE_OFFSET
             : x1;
         const mainY = dragMain ? dragMain.y : y;
         const mainWidth = mainRectWidth(x1, x2, dragLeftX, dragRightX);
         const leftX = dragMain
             ? dragMain.x - HANDLE_OFFSET
             : dragLeftX !== null
             ? dragLeftX
             : leftHandleX(x1);
         const rightX = dragMain
             ? dragMain.x + mainWidth - HANDLE_OFFSET
             : dragRightX !== null
             ? dragRightX
             : rightHandleX(x1, x2 - x1);
         const handleY = mainY;
