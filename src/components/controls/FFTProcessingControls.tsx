...
const FFTProcessingControls: React.FC<FFTProcessingControlsProps> = ({ windowSize, setWindowSize, hopSize, setHopSize, fileLoaded }) => {
    ...
    const setMinDbDelta = useAppStore((state) => state.setMinDbDelta);
        ...
        const setSelectedEngine = useAppStore(
            (state) => state.setSelectedEngine
        );
    ...
    return (
        ...
        >
            ...
            {detectionMethod === "spectral-flux" && (
                ...
                >
                    <Tooltip
                        title="Window size for adaptive threshold (median/MAD). Larger = more context, less sensitive."
                        enterDelay={400}
                        leaveDelay={100}
                        ...
                        <span>
                            ...
                            >
                                ...
                                <Slider
                                    ...
                                    onChange={(_event: Event, v) =>
                                        setSpectralFluxWindow(
                                            typeof v === "number"
                                                ? v
                                                : Array.isArray(v)
                                                ? v[0]
                    ...
                    <Tooltip
                        title="Threshold multiplier (k) for adaptive threshold: median + k × MAD. Higher = fewer impulses."
                        enterDelay={400}
                        leaveDelay={100}
                        disableFocusListener
                        disableTouchListener
                    ...
                    <Tooltip
                        title="Minimum frames between impulses. Higher = more separation, fewer impulses."
                        enterDelay={400}
                        leaveDelay={100}
                        disableFocusListener
                        disableTouchListener
            ...
            {detectionMethod !== "spectral-flux" && (
                ...
                >
                    <Tooltip
                        title={
                            <>
                                <b>Derivative Mode:</b>
                                <br />
                                <b>Centered</b>: (default) Slope between points
                                before/after, best for local rate of change.
                                <br />
                                <b>Forward</b>: Difference from previous window
                                (step-like for large window).
                                <br />
                                <b>Moving Avg</b>: Average of differences over
                                window (smooth, slightly lagged).
                            </>
                        }
                        placement="top"
                        arrow
                    ...
                    <Tooltip
                        title="Derivative window size: how many frames apart to compare for rate of change. Larger = less sensitive, smoother derivative."
                        enterDelay={400}
                        leaveDelay={100}
                        disableFocusListener
                        disableTouchListener
            ...
            <Tooltip
                title="Smoothing window: moving average applied to the magnitude curve before detection. Larger = smoother, less sensitive to noise."
                enterDelay={400}
                leaveDelay={100}
                disableFocusListener
                disableTouchListener
            ...
            <Tooltip
                title="Minimum dB (ignore background noise)"
                enterDelay={400}
                leaveDelay={100}
                disableFocusListener
                disableTouchListener
            ...
            <Tooltip
                title="Minimum dB Change (only count big jumps)"
                enterDelay={400}
                leaveDelay={100}
                disableFocusListener
                disableTouchListener
