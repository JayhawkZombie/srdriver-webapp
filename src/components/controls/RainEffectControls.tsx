import { Group, Text, Button, type RangeSliderValue, Stack, Grid } from "@mantine/core";
...
export const RainEffectControls: React.FC<Props> = ({ srDriver }) => {
	...
	const [ringWidthRange, setRingWidthRange] = useState<RangeSliderValue>([2, 4]);
	...
	const [lifetimeRange, setLifetimeRange] = useState<RangeSliderValue>([0.5, 2.0]);
	const [amplitudeRange, setAmplitudeRange] = useState<RangeSliderValue>([0.3, 1.0]);
	const [speedFactor, setSpeedFactor] = useState(1.0);
	const [spawnColumnRange, setSpawnColumnRange] = useState<RangeSliderValue>([-8 + 8, 38 + 8]);
	const [spawnRowRange, setSpawnRowRange] = useState<RangeSliderValue>([-8 + 8, 38 + 8]);
