        ...
        <Card shadow="sm" padding="lg" radius="md" withBorder>
            ...
            <Stack gap="sm" w="100%">
                <ColorInput
                    value={onLight}
                    onChange={setOnLight}
                    placeholder="Pick on light color"
                />
                <ColorInput
                    value={offLight}
                    onChange={setOffLight}
                    placeholder="Pick off light color"
                />
                <LabeledSlider
                    label="Speed"
                    value={speed}
                ...
                <Group gap="sm" w="100%">
                    <Stack gap="sm" w="fit-content">
                        <Checkbox
                            ...
                            onChange={(event) => {
                                setUseRightCoefficients(
                                    event.currentTarget.checked
                                );
                            }}
                        />
                        <CoeffecientsControls
                            coefficients={c_rt}
                            onChange={setC_rt}
                        />
                    </Stack>
