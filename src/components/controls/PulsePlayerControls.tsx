...
import { Stack, Text, Button, type RangeSliderValue, Grid } from "@mantine/core";
...
export const PulsePlayerControls: React.FC<Props> = ({ srDriver }) => {
	...
	const [pulseWidthRange, setPulseWidthRange] = useState<RangeSliderValue>([5, 30]);
	const [pulseSpeedRange, setPulseSpeedRange] = useState<RangeSliderValue>([5, 30]);
	const [timeBetweenSpawnsRange, setTimeBetweenSpawnsRange] = useState<RangeSliderValue>([
		0.1, 10.0,
	]);
