...
export const SD_CARD_COMMAND_CHARACTERISTIC_UUID = '89fdb60e-48f3-4bb1-8093-39162054423e';
export const SD_CARD_STREAM_CHARACTERISTIC_UUID = '7b7e6311-de69-49b3-8a27-ac57b9aa2673';
...
export interface ISRDriverController {
  ...
  isConnected(): boolean;
  setBrightness(value: number, delay?: number): void;
  setSpeed(value: number, delay?: number): void;
  setPattern(index: number, delay?: number): void;
  setHighColor(color: RGBColor, delay?: number): void;
  setLowColor(color: RGBColor, delay?: number): void;
  setLeftSeriesCoefficients(coeffs: [number, number, number], delay?: number): void;
  setRightSeriesCoefficients(coeffs: [number, number, number], delay?: number): void;
  ...
  firePattern(patternIndex: number, patternArgument: string): Promise<void>;
